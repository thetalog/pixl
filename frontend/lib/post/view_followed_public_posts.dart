  ...
  Future<void> fetchAllPosts() async {
    try {
      final res = await http.get(
        ...
        headers: {
          "Authorization":
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Ikplc3NpY2ExQGV4YW1wbGUuY29tIiwibmFtZSI6Ikplc3NpY2ExIiwidXNlck5hbWUiOiJKZXNzaWNhMSIsImV4cCI6MTc3MjAwNzAzMywiaWF0IjoxNzY5NDE1MDMzfQ.fdsY1CIPh8Fi_3BE3_75MnymoskYbuNQHH43bCT1DEM",
        },
      );
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          final res = await http.patch(
                            Uri.parse(
                                Config.buildApiUrl('/posts/like-or-unlike/$postId')),
                            headers: {
                              "Authorization":
                                  "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Ikplc3NpY2ExQGV4YW1wbGUuY29tIiwibmFtZSI6Ikplc3NpY2ExIiwidXNlck5hbWUiOiJKZXNzaWNhMSIsImV4cCI6MTc3MTkzOTQ5NiwiaWF0IjoxNzY5MzQ3NDk2fQ.CccKMdlGeJ2DdXP_dt_J2DNCiCVooAY0ERt1a8-g_xE",
                            },
                          );
