...
import 'package:pixl/live/stream_chats.dart';
    ...
    try {
      final response = await http.post(
        ...
        headers: {
          ...
          "Authorization":
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Implc3NpY2FAZXhhbXBsZS5jb20iLCJuYW1lIjoiSmVzc2ljYSIsInVzZXJOYW1lIjoiSmVzc2ljYSIsImV4cCI6MTc3MzEyNDMxNywiaWF0IjoxNzcwNTMyMzE3fQ.YFicSKz9_zf9xzyWl8HIm7ehQF0_Z9j6L51XEmZYm9M"
        },
        body: jsonEncode({
