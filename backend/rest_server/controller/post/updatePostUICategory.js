const { updatePostCategory } = require("../../database/post/updateUICategory");
const { UICategory } = require("@prisma/client");

/* ================= UPDATE UI CATEGORY ================= */

exports.updatePostUICategoryController = async (req, res) => {
    try {
        ...
        const response = await updatePostCategory(postId, categoryUpperCase);
