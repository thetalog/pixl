import { dbLikeOrUnlikeReel } from "../../database/query/posts/dbLikeOrUnlikeReel.js";

/* ================= LIKE / UNLIKE REEL ================= */

export const likeOrUnlikeReelController = async (req, res) => {
    try {
        const user = req.user;
        ...
        const response = await dbLikeOrUnlikeReel(user, reelId);
